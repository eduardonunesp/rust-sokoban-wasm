...
var importObject = {
    env: {
        ...
        audio_init: function (audio_buffer_size) {
            if (audioCtx != null) {
                return;
            }
            window.startPause = 0;
        ...
        audio_sample_rate: function () {
            return audioCtx.sampleRate;
        },
        audio_current_time: function () {
            return audioCtx.currentTime;
        },
        audio_samples: function (buffer_ptr, start_audio) {
            var buffer = audioCtx.createBuffer(2, buffer_size, audioCtx.sampleRate);
            ...
            var bufferSec = buffer_size / audioCtx.sampleRate;
            return bufferSec;
        },
    ...
    if (typeof WebAssembly.instantiateStreaming === 'function') {
        WebAssembly.instantiateStreaming(req, importObject)
            .then(obj => {
                ...
                console.log('Loading time secs:', t2 - t1);
            });
    } else {
        req
